...
function cursorTemplate({ x, y, name }) {
  ...
  li.classList = 'flex flex-col absolute pointer-events-none whitespace-nowrap overflow-hidden text-pink-300'
  li.style.left = x + 'px';
  li.style.top = y + 'px';
...
//
// In your "lib/picture_this_web/router.ex":
//
//     pipeline :browser do
//       ...
//       plug MyAuth
...
// inside a script tag in "lib/picture_this_web/templates/layout/app.html.heex":
//
//     <script>window.userToken = "<%= assigns[:user_token] %>";</script>
//
// You will need to verify the user token in the "connect/3" function
// in "lib/picture_this_web/channels/user_socket.ex":
//
