...
<div>
<div class="border-2 rounded-md border-secondary shadow-69xl shadow-secondary xl:h-xl-jr lg:h-rr lg:mt-24 lg:mb-2 sm:h-36 sm:w-96 mt-16 mw-72 w-48 bg-neutral p-3">
  {#if playerz.length > 0}
